...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    	...
    	<div class="row">
            <c:if  test="${!empty questaoInstitutoList}">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
	                <div class="table-responsive">
	                	<form:form method="post" commandName="questaoInstitutoForm" action="listar">
	                	...
	                	<table class="table table-bordered table-striped table-hover" id="tabelaInstituto">
		                    ...
		                    <tbody>
		                    <c:forEach items="${questaoInstitutoList}" var="questaoInstituto">
		                        <tr data-id="${questaoInstituto.id}">
		                            <sec:authorize access="hasRole('ROLE_ADMIN')">
		                            <td>${questaoInstituto.id}</td>
		                            </sec:authorize>
		                            <td>${questaoInstituto.descricao}</td>
		                        </tr>
		                    </c:forEach>
		                    </tbody>
		                </table>
