...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
      ...
      <div class="panel panel-default">
	                ...
	                <!-- /.panel-heading -->
	                <form:form method="post" action="processImport" modelAttribute="atividadeForm">
							    ...
							    <ol class="dd-list">
							        ...
							        <li class="dd-item dd3-item" data-id="${status.count}">
							            ...
							            <div class="dd3-content">
											...
											<form:hidden path="atividades[${status.index}].descricao" value="${atividade.nome}"/>
							            ...
							            <ol class="dd-list">
							                ...
							                <li class="dd-item dd3-item" data-id="${status2.index}">
							                    ...
							                    <div class="dd3-content">
													...
													<form:hidden path="atividades[${status.index}].subAtividades[${status2.index}].descricao" value="${subAtividade.nome}"/>
									            ...
									            <ol class="dd-list">
									                ...
									                <li class="dd-item dd3-item" data-id="${status3.index}">
									                    ...
									                    <div class="dd3-content">
															...
															<form:hidden path="atividades[${status.index}].subAtividades[${status2.index}].subAtividades[${status3.index}].descricao" value="${subAtividade.nome}"/>
									                        ${subAtividade.viewOrder} - ${subAtividade.nome}
									                    </div>
									                    <c:if test="${! empty subAtividade.lista}">
											            <ol class="dd-list">
											                ...
											                <li class="dd-item dd3-item" data-id="${status4.index}">
											                    ...
											                    <div class="dd3-content">
																	...
																	<form:hidden path="atividades[${status.index}].subAtividades[${status2.index}].subAtividades[${status3.index}].subAtividades[${status4.index}].descricao" value="${subAtividade.nome}"/>
											                        ${subAtividade.viewOrder} - ${subAtividade.nome}
											                    </div>
											                    <c:if test="${! empty subAtividade.lista}">
													            <ol class="dd-list">
													                ...
													                <li class="dd-item dd3-item" data-id="${status5.index}">
													                    ...
													                    <div class="dd3-content">
																			...
																			<form:hidden path="atividades[${status.index}].subAtividades[${status2.index}].subAtividades[${status3.index}].subAtividades[${status4.index}].subAtividades[${status5.index}].descricao" value="${subAtividade.nome}"/>
													                        ${subAtividade.viewOrder} - ${subAtividade.nome}
													                    </div>
													                </li>
													                </c:forEach>
