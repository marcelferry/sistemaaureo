...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sssssm-offset-3 hidden">
                <div class="login-panel panel panel-primary">
                    <div class="panel-heading">
            ...
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 ">
                <div class="login-panel panel panel-primary">
                    ...
                    <div class="panel-body">
                        O sistema gestão de metas, esta em manutenção, pós rodizio. Em breve avisaremos o retorno.
                    </div>
                </div>
            </div>
        </div>
