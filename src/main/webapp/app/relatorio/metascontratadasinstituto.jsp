...
<script>
	...
	$(document).ready(function() {
		...
		$('#tabelaRodizio tbody').on( 'dblclick', 'tr', function () {
	            ...
	            "aoColumns": [
	                ...
	                {  "mData": null,
		  	              "mRender": function(data, type, full){
		                       return '<button type="button" class="btn btn-primary btn-xs metas" data-instituto="' + full.id + '">Metas</button>';   // replace this with button 
		                      }
	               		},
	            ]
	        } );
			...
			$('#tableInstituto tbody tr').css( 'cursor', 'pointer' );

			$('#tableInstituto tbody tr').bind('selectstart', function(event) {
			    event.preventDefault();
			});
			      ...
			      if ( ! $.fn.DataTable.isDataTable( '#tableMetas' ) ) {
				      ...
				      $("#tableMetas").dataTable( {
				          ...
				          fnInitComplete: function ( oSettings )
				          {
				              ...
				              {
				            	  console.log(oSettings.aoData[i]);
