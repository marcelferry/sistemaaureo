...
-->
      ...
      <div class="row">
            <form:form method="post" action="add" commandName="pessoa" class="form-horizontal">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="dadosgerais">
	                ...
	                <div class="form-group">
	                	...
	                	<div class="col-sm-4">
	                		<form:input path="nomeCompleto"  cssClass="form-control" onkeyup="this.value=this.value.toUpperCase();"/>
	                	</div>
		            </div>
	                <div class="form-group">
			            <form:label class="col-sm-2 control-label" path="nomeCracha">Nome Crachá</form:label>
	                	<div class="col-sm-5">
	                		<form:input path="nomeCracha"  cssClass="form-control" onkeyup="this.value=this.value.toUpperCase();"/>
	                	</div>
		            </div>
	    			...
	    			<div class="form-group">
	                	...
	                	<div class="col-sm-4">
	                		<form:input path="naturalidade"  cssClass="form-control"  onkeyup="this.value=this.value.toUpperCase();"/>
	                	</div>
		            </div>
	    			...
	    			<div class="form-group">
	                	...
	                	<div class="col-sm-4">
	                		<form:input path="nacionalidade"  cssClass="form-control"  onkeyup="this.value=this.value.toUpperCase();"/>
	                	</div>
		            </div>
		        </div>
	            <div class="tab-pane" id="documentos">
	    			...
	    			<div class="form-group">
	                	...
	                	<div class="col-sm-2">
	                		<form:input path="orgaoEmissor"  cssClass="form-control"  onkeyup="this.value=this.value.toUpperCase();"/>
	                	</div>
	            ...
	            <div class="tab-pane" id="endereco">
		            ...
		            <div class="form-group">
	                	...
	                	<div class="col-sm-10">
	                		<form:input path="endereco.logradouro" cssClass="form-control upper" readonly="${pessoa.endereco.cepUnico == false && pessoa.endereco.buscaCep == true }"/>
	                	</div>
		            </div>
		            <div class="form-group">
		            ...
		            <div class="form-group">
	                	...
	                	<div class="col-sm-4">
	                		<form:input path="endereco.bairro" cssClass="form-control upper" readonly="${pessoa.endereco.cepUnico == false && pessoa.endereco.buscaCep == true }"/>
	                	</div>
		            </div>
		            <div class="form-group">
		                ...
		                <div class="col-sm-5">
							...
							<form:input path="endereco.cidade.nome" cssClass="form-control upper" readonly="${ pessoa.endereco.buscaCep == true }"/>
						</div>
					</div>
		            ...
		            <div class="form-group">
	                	...
	                	<div class="col-sm-2">
	                		<form:input path="endereco.cidade.estado.sigla" cssClass="form-control upper" readonly="${ pessoa.endereco.buscaCep == true }"/>
	                	</div>
		            </div>
	            </div>
		    			...
		    			<table class="table small" id="emails">
		                    ...
		                    <c:forEach items="${pessoa.emails}" varStatus="loop">
		                        ...
		                        <c:choose>
		                            ...
		                            <td>
		                            <!-- Generate the fields -->
		                           		 <form:input path="emails[${loop.index}].contato" placeholder="Contato"  class="form-control input-sm upper" />
		                            </td>
		                            <td>
			                            <!-- Generate the fields -->
