									 ...
									 <td>
		                            	...
		                            	<form action="edit/${atividade.id}" method="post">
		                            		<div class="col-md-12">
				                            	...
				                            	<div class="col-md-4">
				                            		<input type="button" onclick="this.form.action = 'listar/naoplanejadas/${atividade.id}';submit();" class="btn btn-danger btn-xs" value="Não Planejadas"/>
			                            		</div>
		                            		</div>
		                            	</form>
		                            	</c:if>
									...
									<tr id="subatividade${status2.count}_atividade${status.count}" class="child">
		                            	...
		                            	<form action="edit/${subAtividade.id}" method="post">
			                            	<div class="col-md-12">
				                            	...
				                            	<div class="col-md-4">
				                            		<input type="button" onclick="this.form.action = 'listar/naoplanejadas/${subAtividade.id}';submit();" class="btn btn-danger btn-xs" value="Não Planejadas"/>
			                            		</div>
		                            		</div>
		                            	</form>
		                            	</c:if>
