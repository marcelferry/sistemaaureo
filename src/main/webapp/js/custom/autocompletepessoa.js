 ...
 */
	...
	function completePessoa(nameField, idField, baseUrl, callbackUpdater){
		nameField.typeahead({
			    source: function (query, process) {
			        return $.ajax({
			            url: baseUrl + '/gestao/pessoa/list',
			            type: 'Get',
			            ...
			            success: function (result) {	
			                var resultList = result.map(function (item) {
			                    var aItem = { id: item.id, name: item.nome, cpf: item.cpf, cidade: item.cidade, uf: item.uf, email: item.email };
			    ...
			    highlighter: function (obj) {
			        ...
			        var itm = ''
		                 ...
		                 + "<div class='typeahead_secondary'>" + item.email + " - "+ item.cidade + "/" + item.uf + "</div>"
		                 + "</div>"
		                 + "</div>";
		        	return itm;
			    },
