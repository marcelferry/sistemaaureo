...
public class UsuarioRestController {
	...
	public ResponseEntity<?> authenticate(@RequestParam("username") String username,
		...
		try {
			...
			result.setCiclo(new RodizioVO(rodizio));
	...
	public @ResponseBody String listaHistoricoLogin(
			...
			@RequestParam(value = "iDisplayLength", required = false) int pageDisplayLength, HttpServletRequest request)
			throws IOException {
		...
		retorno = loginHistoryService.listRangeLoginHistory(searchParameter, sortCol, sortDir, startRange,
				pageDisplayLength);
