...
public class PlanoMetasForm {
	...
	/*
	 * 01 - Selecao Rodizio / Instituto 02 - Selecao Cidade / Entidade / Contratante
	 * 03 - Preenchimento das Metas 04 - Validação Secretaria
	 */
	...
	private StatusAtualInstitutoGraphicData situacaoAtual;
	
	private StatusAtualInstitutoGraphicData situacaoDesejada;
	...
	public StatusAtualInstitutoGraphicData getSituacaoAtual() {
		return situacaoAtual;
	}

	public void setSituacaoAtual(StatusAtualInstitutoGraphicData statusAtualInstitutoGraphicData) {
		this.situacaoAtual = statusAtualInstitutoGraphicData;
	}
	
	public StatusAtualInstitutoGraphicData getSituacaoDesejada() {
		return situacaoDesejada;
	}
	
	public void setSituacaoDesejada(StatusAtualInstitutoGraphicData statusAtualInstitutoGraphicData) {
		this.situacaoDesejada = statusAtualInstitutoGraphicData;
	}

	@Override
	public String toString() {
		return "PlanoMetasForm [id=" + id + ", rodizio=" + rodizio + ", instituto=" + instituto + ", entidade="
				+ entidade + "]";
	}
