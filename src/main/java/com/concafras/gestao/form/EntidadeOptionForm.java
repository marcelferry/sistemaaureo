...
public class EntidadeOptionForm {
	...
	public String toString() {
		return "EntidadeOptionForm [id=" + id + ", razaoSocial=" + razaoSocial + ", endereco=" + endereco
				+ ", telefone=" + telefone + ", presidente=" + presidente + ", dirigente=" + dirigente + ", outro="
				+ outro + ", cidade=" + cidade + ", uf=" + uf + ", count=" + count + "]";
	}
