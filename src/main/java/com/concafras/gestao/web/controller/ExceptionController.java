...
import com.concafras.gestao.model.exception.FunctionalException;
import com.concafras.gestao.model.exception.JqueryBussinessException;

@Controller
@RequestMapping("/gestao/exception")
public class ExceptionController
{
	...
	@ResponseBody
	public ExceptionVO handleException5(JqueryBussinessException ex, HttpServletResponse response) throws IOException
	{
		ExceptionVO exceptionVO = new ExceptionVO("handleException5()", "ExceptionController", ex.getMessage());
