...
public class EmailController {
	...
	public @ResponseBody boolean enviarConvite(@RequestParam("entidadeId") Integer entidadeId,
			@RequestParam("assunto") String assunto, @RequestParam("mensagem") String mensagem) {
	...
	public @ResponseBody boolean enviarConvite(@PathVariable("pessoaId") Integer pessoaId,
		...
		emailService.sendConvite(pessoa, entidade);

		return true;
	}

	@RequestMapping("/entidade/sendConviteTodos")
	public @ResponseBody boolean enviarConviteTodos() {

		emailService.sendConviteTodos();

		return true;
	}

	@RequestMapping("/entidade/sendLembreteTodos/{ciclo}")
	public @ResponseBody boolean enviarLembreteTodos(@PathVariable("ciclo") Integer cicloId) {
	...
	public @ResponseBody boolean enviarLembrete(@PathVariable("ciclo") Integer cicloId,
			@PathVariable("entidade") Integer entidadeId, @PathVariable("pessoa") Integer pessoaId) {
		// TODO: change to rodizio object from session
		Rodizio ciclo = new Rodizio();
		ciclo.setId(cicloId);
